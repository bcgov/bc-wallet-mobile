...
const translation = {
  ...
  "Notification": {
    ...
    "ContinueVerification": {
      "Title": "You're not verified (FR)",
      "Description": "Complete the verification process at anytime. (FR)",
      "ButtonTitle": "Continue (FR)",
    },
    "PendingReview": {
      "Title": "Your identity verification is pending (FR)",
      "Description": "We've received your request to verify your identity. (FR)",
      "ButtonTitle": "Check status (FR)"
    },
    "CancelledReview": {
      "Title": "Your identity could not be verified (FR)",
      "Description": "Verify your identity again to access services. (FR)",
      "ButtonTitle": "See details (FR)"
    },
    "Verified": {
      "Title": "Your identity has been verified (FR)",
      "Description": "Complete the verification process. (FR)",
      "ButtonTitle": "Finish up (FR)"
    },
    "AccountExpired": {
      "Title": "Your BC Services Card account has expired (FR)",
    ...
    "AccountRenewal": {
      ...
      "Description": "Renew your BC Services Card account before it expires on {{expiryDate}} (FR)",
      "ButtonTitle": "Start renewal (FR)"
    },
    "BasicMessage": {
  ...
  "Developer": {
    ...
    "DeleteTokens": "Delete Tokens (FR)",
    "DeletedTokens": "Deleted tokens (FR)",
    "FetchPersonCredentialTest": "Fetch Person Credential (FR)",
    "FetchPersonCredentialStatus": "Status (FR)",
  ...
  "BCSC": {
    ...
    "Screens": {
      ...
      "AccountDetails": "Account information (FR)",
    },
    "HelpMenu": {
      "Title": "Need help? (FR)",
    ...
    "Contacts": {
      ...
      "SearchPlaceholder": "Search contacts (FR)",
      "WhatAre": {
      ...
      "EditName": {
        "HeaderTitle": "Contact Details (FR)",
        "Title": "Edit contact name (FR)",
        "Description": "This contact name is only displayed in your Contacts list. (FR)",
        "Label": "Contact name (FR)",
        "EmptyTitle": "Empty contact name (FR)",
        "EmptyDescription": "Please enter a contact name. (FR)",
        "TooLongTitle": "Contact name too long (FR)",
        "TooLongDescription": "Contact names must be 50 characters or fewer. (FR)",
      },
      "JSON": {
        "Title": "Contact Details (FR)",
      ...
      "Chat": {
        ...
        "InfoAccessibilityLabel": "Contact info (FR)",
      },
      "Remove": {
        "HeaderTitle": "Remove Contact (FR)",
        "Title": "Remove this Contact (FR)",
        "WarningTop": "Removing this Contact will delete all existing messages and notifications from them. (FR)",
        "NoLongerAble": "With this Contact, you'll no longer be able to: (FR)",
        "Bullet1": "Send or receive messages (FR)",
        "Bullet2": "Be notified of updates to your credentials (FR)",
        "Bullet3": "Get offered new credentials (FR)",
        "Bullet4": "Request proof of information (FR)",
        "WarningBottom": "They won't be notified that you removed them from your Contacts. (FR)",
        "RemoveContact": "Remove Contact (FR)",
        "FailureTitle": "Could not remove contact (FR)",
      },
    },
    "Loading": {
    ...
    "Settings": {
      ...
      "HelpHeader": "Help (FR)",
      "MoreInfoHeader": "More Information (FR)",
      "Help": "Help (FR)",
      "HelpUsingApp": "Help using BC Services Card app (FR)",
      "SignOut": "Sign out (FR)",
      ...
      "ChangeNotificationsInstructions": "To change notification settings: (FR)",
      "NotificationsStep1": "Go to device settings (FR)",
      "NotificationsStep2": "Tap Notifications (FR)",
      "NotificationsStep3": "In app notifications, find the BC Services Card app (FR)",
      "NotificationsStep4": "Turn on or off notifications (FR)",
      "OpenDeviceSettings": "Go to device settings (FR)",
      ...
      "GiveFeedback": "Give us feedback (FR)",
      "Accessibility": "Accessibility (FR)",
      "AnalyticsOptIn": "Analytics (FR)",
      "Theme": "Theme (FR)",
      "ThemeLight": "Light (FR)",
      "ThemeDark": "Dark (FR)",
      ...
      "ResetWallet": "Reset wallet features (FR)",
      "Features": {
        "Header": "Features (FR)",
        "Contacts": "Contacts (FR)",
        "ScanQR": "Scan my QR code (FR)",
        "SendProofRequest": "Send a proof request (FR)",
    ...
    "Services": {
      ...
      "NotListedDescriptionContact": "Contact the service if you wish to see them listed here. (FR)",
    ...
    "Modals": {
      ...
      "VerificationSessionExpired": {
        "Header": "Verification session expired (FR)",
        "ContentA": "More than 7 days have passed since you started verifying your identity, so this session has expired. (FR)",
        "ContentB": "To continue, you'll need to set up the app and verify your identity again. (FR)",
        "Button": "Start again (FR)",
      },
      "DeviceInvalidated": {
        "Header": "Device invalidated (FR)",
        "CancelledByCardCancel": "Your account will be removed from this app. (FR)",
        "CancelledByAgent": "Your account was removed from the app on this device at a Service BC location or by the service. (FR)",
        "CancelledByUser": "You made a change on id.gov.bc.ca to remove your account from the app on this device. (FR)",
    ...
    "ReverifyAccount": {
      ...
      "ExpiredTitle": "Your BC Services Card account has expired (FR)",
    ...
    "AccountDetails": {
      "Title": "Account information (FR)",
      "AccountNickname": "Account nickname (FR)",
      "Edit": "Edit (FR)",
      "SeeFullDetails": "See full account details (FR)",
    },
    "NicknameAccount": {
      "AccountName": "Account Nickname (FR)",
      "EnterNickname": "Enter a nickname (FR)",
      "CreateAccountName": "Create a nickname for your account on this device. It identifies you: (FR)",
      "EditAccountName": "Create a nickname for your account on this device. It identifies you: (FR)",
      "AccountNameDescription1": "In notifications (FR)",
      "AccountNameDescription2": "When you connect and communicate with other contacts (FR)",
    ...
    "ManualPairing": {
      "EnterPairingCodeTitle": "Enter your pairing code (FR)",
      "PairingCodeLabel": "Pairing code (FR)",
      "EnterPairingCodeMessage": "To get a 6-digit code, start signing in to a service on your computer or other device. Enter the code in this app. (FR)",
      ...
      "BookmarkServiceButton": "Bookmark this service? (FR)",
    ...
    "Onboarding": {
      ...
      "SecureAppOnboardingDeviceAuthTitle": "Use device unlock (FR)",
      ...
      "AnalyticsContent": "With your permission, we'll collect additional usage and device details to help us improve this app. (FR)",
    ...
    "ManualSerial": {
      ...
      "FormatError": "Enter a valid card serial number (FR)",
    },
    "Birthdate": {
      "CardSerialNumber": "Card serial number: {{ serial }} (FR)",
      "Heading": "Enter your birthdate (FR)",
      "Paragraph": "Your birthdate is only used to to set up this app. It will not be stored on this device. (FR)",
    ...
    "VerifyPrompt": {
      ...
      "Description": "Services may require a verified account. It gives you access to more services that need to know who you are. (FR)",
      ...
      "SkipVerification": "Skip verification (FR)",
    },
    "NewSetup": {
      "Title": "New setup (FR)",
      "YouWillNeedTo": "You will need to: (FR)",
    ...
    "EnterEmail": {
      ...
      "NotificationsBullet2": "Account changes (FR)",
      "NotificationsBullet3": "Eligibility for government services (FR)",
    },
    "EmailConfirmation": {
      ...
      "EnterVerificationCode": "Enter your verification code (FR)",
      "CodeSentTo": "A 6-digit verification code was just sent to (FR)",
    ...
    "SendVideo": {
      "PendingReview": {
        "Heading": "Your identity verification is pending (FR)",
        "Description1": "Verification request received (FR)",
        "BulletHeader": "We review requests: (FR)",
        "Bullet1": "Monday to Friday, 9am to 5pm (FR)",
        "Bullet2": "In the order they're received (FR)",
        "Description2": "Usually, we review requests within 2 business days. (FR)",
        "Description3": "Requests sent in on the weekend will be reviewed after we open on Monday. (FR)",
        "Description4": "It may take up to 10 business days. (FR)",
      },
      "SuccessfullySent": {
    ...
    "PhotoInstructions": {
      ...
      "Bullet2": "Remove your glasses - if possible (FR)",
    ...
    "VideoCall": {
      ...
      "StartVideoCallDescription": "The agent will verify your identity to finish setting up this app. (FR)",
      "YouShould": "You should: (FR)",
    ...
    "EvidenceIDCollection": {
      ...
      "FirstNameLengthError": "Enter 15 characters or less (FR)",
      "LastNameLabel": "Last name (FR)",
      "LastNameError": "Please enter a last name (FR)",
      "LastNameLengthError": "Enter 35 characters or less (FR)",
      ...
      "MiddleNamesLengthError": "Enter 30 characters or less (FR)",
    ...
    "Address": {
      ...
      "ProvincePlaceholder": "Select a province or territory (FR)",
      "ProvinceSubtext": "For example, BC or British Columbia (FR)",
  ...
  "Alerts": {
    ...
    "DynamicRegistrationError": {
      "Title": "Problem with Service (FR)",
      "Description": "The OS on this device is not supported. Please update your device and make sure it's not a beta version. (error {{ errorCode }}) (FR)"
    },
    "AddCardNotAvailable": {
