...
const translation = {
  ...
  "Unified": {
    ...
    "AdditionalEvidence": {
      ...
      "CheckYourIDBullet1": "<b>Has the same name as on your BC Services Card</b> (FR)",
      "CheckYourIDBullet2": "<b>Has a recent photo</b> (FR)",
      "CheckYourIDBullet3": "<b>Is not expired</b> (FR)",
      "LimitedAccess": "Limited access to services (FR)",
      "LimitedAccessDescription": "Some services only accept the app when it's set up with a photo ID. (FR)",
