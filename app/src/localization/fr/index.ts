...
const translation = {
  ...
  "BCWalletError": {
    ...
    "Network": {
      "Title": "Server Error (FR)",
      "UnknownServerErrorDescription": "An unknown server error occurred. Please try again later. (FR)",
      "NoInternetTitle": "No Internet Connection (FR)",
      "NoInternetDescription": "No internet connection. Please check your network settings and try again. (FR)",
      "ServerErrorDescription": "There is a problem with the service. Please try again later. (error 302) (FR)",
      "TimeoutTitle": "Connection Error (FR)",
      "TimeoutDescription": "Please try again later. (FR)",
      "UnsecuredTitle": "Unsecured Network (FR)",
      "UnsecuredDescription": "A secure internet connection is required. Please check your network and try again. (FR)",
      ...
      "TooManyAttemptsTitle": "Sorry, You've Tried Too Many Times (FR)",
      "TooManyAttemptsDescription": "Please try again later. (FR)",
    },
    "Login": {
      "Title": "Problem with App (FR)",
      "ProblemWithLoginTitle": "Problem with Login (FR)",
      "ParseErrorDescription": "Please try again later. (error 304) (FR)",
      "Rejected": "There may be a problem with your account in this app. Please try again. If the problem continues, remove and add your account again.  (FR)",
      "Unauthorized": "You are not authorized to access this service. (FR)",
      "Forbidden": "Access to this service is forbidden. (FR)",
      "ServerErrorDescription": "Please try again later. (error 303) (FR)",
      "InvalidPairingCodeTitle": "Invalid Pairing Code (FR)",
      "InvalidPairingCodeDescription": "You've entered an invalid pairing code. Please re-enter your pairing code and try again. (FR)",
      "SameDeviceInvalidPairingCodeTitle": "Invalid Login (FR)",
      "SameDeviceInvalidPairingCodeDescription": "Please try again later. If the problem continues, contact the BC Services Card Help Desk. (FR)",
    },
    "Card": {
      "Title": "Card Error (FR)",
    ...
    "Verification": {
      ...
      "NotCompleteTitle": "Verify Not Complete (FR)",
      "NotCompleteDescription": "Go to a Service BC location to verify your identity. (FR)",
      ...
      "VerifyRequestExpiredTitle": "Setup Expired (FR)",
      "VerifyRequestExpiredDescription": "You must start set up again. (FR)",
    },
    "Token": {
      "Title": "Problem with App (FR)",
      "Invalid": "There may be a problem with your account in this app. Please try again. If the problem continues, remove and add your account again. (FR)",
      "NoTokensReturnedTitle": "Problem with Account (FR)",
      "NoTokensReturnedDescription": "No authentication tokens were returned. Please try again. (FR)",
    ...
    "Device": {
      ...
      "AppUpdateRequiredTitle": "App Update Required (FR)",
      "AppUpdateRequiredDescription": "You must update this app to continue. (FR)",
      ...
      "KeypairGenerationError": "The app does not appear to be installed correctly. Please remove the app from your device and add it again. (FR)",
      "KeypairGenerationTitle": "Problem with App (FR)",
    },
    "General": {
