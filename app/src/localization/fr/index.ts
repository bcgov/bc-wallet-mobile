const translation = {
  ...
  CameraDisclosure: {
    ...
    ToContinueUsing: "Pour continuer à utiliser la fonction de balayage du Portefeuille QC, veuillez autoriser les autorisations de caméra.",
    Allow: 'Autoriser',
  ...
  PersonCredentialNotification: {
    ...
    Description: 'Ajoutez votre identifiant personnel à votre portefeuille et utilisez-le pour accéder aux services en ligne.',
  },
  PersonCredential: {
    Issuer: 'Service C.-B.',
    Name: 'Personne',
  ...
  Tips: {
    ...
    Tip13: 'Les informations envoyées via votre portefeuille sont approuvées par vous et vos contacts avec lesquels vous interagissez',
