...
const translation = {
  ...
  "BCSC": {
    ...
    "Onboarding": {
      ...
      "CarouselServicesContent": "It's accepted by many governement services. (FR)",
      "CarouselProveContentA": "Log in using just this app. No username or password needed. (FR)",
      "CarouselProveContentB": "Access services from any device by approving login in this app. (FR)",
      "CarouselCannotUseContentA": "It's not a place to store a digital copy of your BC Services Card. (FR)",
      "CarouselCannotUseContentB": "It's your account to access services online only. (FR)",
