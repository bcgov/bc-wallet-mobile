...
const translation = {
  ...
  "BCSC": {
    ...
    "Contacts": {
      ...
      "EditName": {
        ...
        "Description": "This contact name is only displayed in your Contacts list.",
        "Label": "Contact name",
        "EmptyTitle": "Empty contact name",
        "EmptyDescription": "Please enter a contact name.",
        "TooLongTitle": "Contact name too long",
        "TooLongDescription": "Contact names must be 50 characters or fewer.",
      },
      "JSON": {
        "Title": "Contact Details",
        "Download": "Download",
      ...
      "Chat": {
        ...
        "InfoAccessibilityLabel": "Contact info",
      },
      "Remove": {
        "HeaderTitle": "Remove Contact",
        "Title": "Remove this Contact",
        "WarningTop": "Removing this Contact will delete all existing messages and notifications from them.",
        "NoLongerAble": "With this Contact, you'll no longer be able to:",
        "Bullet1": "Send or receive messages",
        "Bullet2": "Be notified of updates to your credentials",
        "Bullet3": "Get offered new credentials",
        "Bullet4": "Request proof of information",
        "WarningBottom": "They won't be notified that you removed them from your Contacts.",
        "RemoveContact": "Remove Contact",
        "FailureTitle": "Could not remove contact",
      },
    },
    "Loading": {
    ...
    "Settings": {
      ...
      "NotificationsAreLabel": "Notifications are:",
      "NotificationsStatusOn": "on",
      "NotificationsStatusOff": "off",
      "ChangeNotificationsInstructions": "To change notification settings:",
      "NotificationsStep1": "Go to device settings",
      "NotificationsStep2": "Tap Notifications",
      "NotificationsStep3": "In app notifications, find the BC Services Card app",
      "NotificationsStep4": "Turn on or off notifications",
      "OpenDeviceSettings": "Go to device settings",
    ...
    "Home": {
      ...
      "LogInFromComputerTitle": "Log in from another device",
      "LogInFromComputerAccessibilityLabel": "Log in from another device",
    ...
    "AccountDetails": {
      ...
      "Edit": "Edit",
      "SeeFullDetails": "See full account details",
    },
    "NicknameAccount": {
      "AccountName": "Account Nickname",
      "EnterNickname": "Enter a nickname",
      "CreateAccountName": "Create a nickname for your account on this device. It identifies you:",
      "EditAccountName": "Create a nickname for your account on this device. It identifies you:",
      "AccountNameDescription1": "In notifications",
      "AccountNameDescription2": "When you connect and communicate with other contacts",
    ...
    "ManualPairing": {
      ...
      "BookmarkServiceButton": "Bookmark this service?",
    ...
    "EnterEmail": {
      ...
      "NotificationsBullet2": "Account changes",
      "NotificationsBullet3": "Eligibility for government services",
    },
    "EmailConfirmation": {
      ...
      "CodeSentTo": "A 6-digit verification code was just sent to",
    ...
    "VideoCall": {
      ...
      "StartVideoCallTitle": "Start a video call to talk with a Service BC agent.",
      "StartVideoCallDescription": "The agent will verify your identity to finish setting up this app.",
      "YouShould": "You should:",
    ...
    "EvidenceIDCollection": {
      ...
      "FirstNameFormatError": "First name must start with a letter A to Z",
      "LastNameLabel": "Last name",
      "LastNameError": "Please enter a last name",
      "LastNameLengthError": "Enter 35 characters or less",
      "LastNameFormatError": "Last name must start with a letter A to Z",
      ...
      "MiddleNamesFormatError": "Middle names must start with a letter A to Z",
      "NameCharactersError": "Enter valid characters only - no accents or symbols",
    ...
    "Address": {
      ...
      "StreetAddressLengthError": "Enter 32 characters or less",
      "StreetAddress2Label": "Apt, suite, etc (optional)",
      "StreetAddress2Subtext": "Apartment, suite, unit, building, floor, etc.",
      "StreetAddress2LengthError": "Enter 32 characters or less",
      "CityLabel": "City",
      "CitySubtext": "The city of your current address",
      "CityRequired": "Please enter a city",
      "CityLengthError": "Enter 32 characters or less",
      "ProvinceLabel": "Province or Territory",
      "ProvincePlaceholder": "Select a province or territory",
      "ProvinceSubtext": "For example, BC or British Columbia",
  ...
  "Alerts": {
    ...
    "InvalidStoredMetadata": {
      "Title": "Application interrupted",
      "Description": "Something went wrong with your verification application. Please restart verification to continue.",
      "Action1": "Restart Verification",
    },
    "DataUseWarning": {
      "Title": "Data Use",
