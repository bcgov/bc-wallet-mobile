...
const translation = {
  ...
  "BCSC": {
    ...
    "SystemChecks": {
      ...
      "AccountExpiredDescription:": {
        ...
        "ExpiredBannerDescription": "Your account on this device expired on {{accountExpiration}}. You need to renew it before you can use it to log in.",
      },
  ...
  "BCWalletError": {
    ...
    "Network": {
      ...
      "UnexpectedError": "An unexpected network error occurred. Please try again.",
    ...
    "Login": {
      "Title": "Login Error",
      "ParseError": "Unable to process the login request. Please try again.",
      ...
      "ServerError": "A server error occurred during login. Please try again.",
      "InvalidPairingCode": "The pairing code is invalid. Please check and try again.",
      "TooManyAttempts": "Too many login attempts. Please wait and try again.",
      "TooManyAccounts": "You have too many active accounts. Please remove one before adding another.",
    },
    "Card": {
      "Title": "Card Error",
    ...
    "Verification": {
      ...
      "NotComplete": "Verification is not complete. Please complete the verification process.",
    ...
    "Token": {
      ...
      "NoTokensReturned": "No authentication tokens were returned. Please try again.",
    ...
    "Device": {
      "Title": "Device Error",
      "AppUpdateRequired": "An app update is required. Please update to continue.",
