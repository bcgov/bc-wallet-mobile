...
const translation = {
  ...
  "Notification": {
    ...
    "ContinueVerification": {
      "Title": "You're not verified (PT-BR)",
      "Description": "Complete the verification process at anytime. (PT-BR)",
      "ButtonTitle": "Continue (PT-BR)",
    },
    "PendingReview": {
      "Title": "Your identity verification is pending (PT-BR)",
      "Description": "We've received your request to verify your identity. (PT-BR)",
      "ButtonTitle": "Check status (PT-BR)"
    },
    "CancelledReview": {
      "Title": "Your identity could not be verified (PT-BR)",
      "Description": "Verify your identity again to access services. (PT-BR)",
      "ButtonTitle": "See details (PT-BR)"
    },
    "Verified": {
      "Title": "Your identity has been verified (PT-BR)",
      "Description": "Complete the verification process. (PT-BR)",
  ...
  "BCSC": {
    ...
    "Screens": {
      ...
      "Nickname": "Nickname (PT-BR)",
      "AccountDetails": "Account information (PT-BR)",
    },
    "HelpMenu": {
    ...
    "Contacts": {
      ...
      "WhatAreContactsButton": "What are contacts? (PT-BR)",
      "HelpAccessibilityLabel": "What are contacts? (PT-BR)",
      "SearchPlaceholder": "Search contacts (PT-BR)",
      "WhatAre": {
        "Title": "What are Contacts? (PT-BR)",
        "Description1": "Contacts are people or organizations you've interacted with. (PT-BR)",
        "Description2": "You're connected over a secure and private line that no one but you or them can see. Nothing is shared without your permission. (PT-BR)",
        "YouCanHeader": "You can: (PT-BR)",
        "Bullet1": "Direct message your Contacts (PT-BR)",
        "Bullet2": "Get offered new credentials (PT-BR)",
        "Bullet3": "Get notified of updates to your credentials issued by them (PT-BR)",
        "Bullet4": "Request for information from your contact or they request information from you (PT-BR)",
        "FooterPrefix": "You can always remove Contacts at anytime from your (PT-BR) ",
        "FooterLink": "Contacts list (PT-BR)",
        "FooterSuffix": ". (PT-BR)",
      },
      "Details": {
      ...
      "EditName": {
        "HeaderTitle": "Contact Details (PT-BR)",
        "Title": "Edit contact name (PT-BR)",
        "Description": "This contact name is only displayed in your Contacts list. (PT-BR)",
        "Label": "Contact name (PT-BR)",
        "EmptyTitle": "Empty contact name (PT-BR)",
        "EmptyDescription": "Please enter a contact name. (PT-BR)",
        "TooLongTitle": "Contact name too long (PT-BR)",
        "TooLongDescription": "Contact names must be 50 characters or fewer. (PT-BR)",
      },
      "JSON": {
        "Title": "Contact Details (PT-BR)",
      ...
      "Chat": {
        ...
        "InfoAccessibilityLabel": "Contact info (PT-BR)",
      },
      "Remove": {
        "HeaderTitle": "Remove Contact (PT-BR)",
        "Title": "Remove this Contact (PT-BR)",
        "WarningTop": "Removing this Contact will delete all existing messages and notifications from them. (PT-BR)",
        "NoLongerAble": "With this Contact, you'll no longer be able to: (PT-BR)",
        "Bullet1": "Send or receive messages (PT-BR)",
        "Bullet2": "Be notified of updates to your credentials (PT-BR)",
        "Bullet3": "Get offered new credentials (PT-BR)",
        "Bullet4": "Request proof of information (PT-BR)",
        "WarningBottom": "They won't be notified that you removed them from your Contacts. (PT-BR)",
        "RemoveContact": "Remove Contact (PT-BR)",
        "FailureTitle": "Could not remove contact (PT-BR)",
      },
    },
    "Loading": {
    ...
    "Settings": {
      ...
      "NotificationsStep4": "Turn on or off notifications (PT-BR)",
      "OpenDeviceSettings": "Go to device settings (PT-BR)",
      ...
      "GiveFeedback": "Give us feedback (PT-BR)",
      "Accessibility": "Accessibility (PT-BR)",
      "AnalyticsOptIn": "Analytics (PT-BR)",
      "Theme": "Theme (PT-BR)",
      ...
      "ResetWallet": "Reset wallet features (PT-BR)",
      "Features": {
        "Header": "Features (PT-BR)",
        "Contacts": "Contacts (PT-BR)",
        "ScanQR": "Scan my QR code (PT-BR)",
        "SendProofRequest": "Send a proof request (PT-BR)",
        "ProofRequests": "Proof Requests (PT-BR)",
      },
      "AppSecurity": {
    ...
    "Services": {
      ...
      "NotListedDescriptionContact": "Contact the service if you wish to see them listed here. (PT-BR)",
    ...
    "Modals": {
      ...
      "DeviceInvalidated": {
        ...
        "CancelledByCardCancel": "Your account will be removed from this app. (PT-BR)",
        "CancelledByAgent": "Your account was removed from the app on this device at a Service BC location or by the service. (PT-BR)",
        "CancelledByUser": "You made a change on id.gov.bc.ca to remove your account from the app on this device. (PT-BR)",
    ...
    "AccountDetails": {
      "Title": "Account information (PT-BR)",
      "AccountNickname": "Account nickname (PT-BR)",
      "Edit": "Edit (PT-BR)",
      "SeeFullDetails": "See full account details (PT-BR)",
    },
    "NicknameAccount": {
      "AccountName": "Account Nickname (PT-BR)",
      "EnterNickname": "Enter a nickname (PT-BR)",
      "CreateAccountName": "Create a nickname for your account on this device. It identifies you: (PT-BR)",
      "EditAccountName": "Create a nickname for your account on this device. It identifies you: (PT-BR)",
      "AccountNameDescription1": "In notifications (PT-BR)",
      "AccountNameDescription2": "When you connect and communicate with other contacts (PT-BR)",
    ...
    "ManualPairing": {
      "EnterPairingCodeTitle": "Enter your pairing code (PT-BR)",
      "PairingCodeLabel": "Pairing code (PT-BR)",
      "EnterPairingCodeMessage": "Enter the 6 digit pairing code on your other device. Please enter the code within 5 minutes. (PT-BR)",
      ...
      "BookmarkServiceButton": "Bookmark this service? (PT-BR)",
    ...
    "Onboarding": {
      ...
      "IntroDescription": "A safe and simple way to access participating government services online. (PT-BR)",
      "IntroCalloutTitle": "We have improved the app! (PT-BR)",
      "IntroCalloutBody": "A refreshed design and better performance. (PT-BR)",
      ...
      "AnalyticsContent": "With your permission, we'll collect additional usage and device details to help us improve this app. (PT-BR)",
    ...
    "Birthdate": {
      ...
      "Paragraph": "Your birthdate is only used to to set up this app. It will not be stored on this device. (PT-BR)",
    ...
    "VerifyPrompt": {
      ...
      "Description": "Services may require a verified account. It gives you access to more services that need to know who you are. (PT-BR)",
      ...
      "SkipVerification": "Skip verification (PT-BR)",
    },
    "NewSetup": {
    ...
    "EnterEmail": {
      ...
      "NotificationsBullet2": "Account changes (PT-BR)",
      "NotificationsBullet3": "Eligibility for government services (PT-BR)",
    },
    "EmailConfirmation": {
      ...
      "EnterVerificationCode": "Enter your verification code (PT-BR)",
      "CodeSentTo": "A 6-digit verification code was just sent to (PT-BR)",
    ...
    "SendVideo": {
      "PendingReview": {
        "Heading": "Your identity verification is pending (PT-BR)",
        "Description1": "Verification request received (PT-BR)",
        "BulletHeader": "We review requests: (PT-BR)",
        "Bullet1": "Monday to Friday, 9am to 5pm (PT-BR)",
        "Bullet2": "In the order they're received (PT-BR)",
        "Description2": "Usually, we review requests within 2 business days. (PT-BR)",
        "Description3": "Requests sent in on the weekend will be reviewed after we open on Monday. (PT-BR)",
        "Description4": "It may take up to 10 business days. (PT-BR)",
      },
      "SuccessfullySent": {
    ...
    "PhotoInstructions": {
      ...
      "Bullet2": "Remove your glasses - if possible (PT-BR)",
    ...
    "TransferQRInformation": {
      ...
      "Instructions": "Scan the QR code using the BC Services Card app on your other mobile device. (PT-BR)",
    ...
    "CancelledVerification": {
      ...
      "Button": "Retry verification (PT-BR)",
    ...
    "VideoCall": {
      ...
      "StartVideoCallDescription": "The agent will verify your identity to finish setting up this app. (PT-BR)",
      "YouShould": "You should: (PT-BR)",
    ...
    "Address": {
      ...
      "ProvincePlaceholder": "Select a province or territory (PT-BR)",
      "ProvinceSubtext": "For example, BC or British Columbia (PT-BR)",
    ...
    "Account": {
      ...
      "RemoveAccountSuccess": "Account removed successfully. (PT-BR)",
      "RemoveAccountError": "Failed to remove account. Please try again. (PT-BR)",
  ...
  "Alerts": {
    ...
    "DynamicRegistrationError": {
      "Title": "Problem with Service (PT-BR)",
      "Description": "The OS on this device is not supported. Please update your device and make sure it's not a beta version. (error {{ errorCode }}) (PT-BR)"
    },
    "AddCardNotAvailable": {
