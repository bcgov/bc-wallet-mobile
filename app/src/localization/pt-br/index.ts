...
const translation = {
  ...
  "BCSC": {
    ...
    "Onboarding": {
      ...
      "NotificationsContentA": "It's recommended you allow this app to receive push notifications. (PR-BR)",
      "NotificationsContentB": "Notification will be sent to you when: (PR-BR)",
      "NotificationsBullet1": "The app is setup and ready to use (PR-BR)",
      "NotificationsBullet2": "You choose to log in (PR-BR)",
      "NotificationsBullet3": "You need to renew and verify your identity again (PR-BR)",
      "NotificationsBullet4": "There are changes to your account (PR-BR)",
