...
const translation = {
  ...
  "BCWalletError": {
    "Camera": {
      "Title": "Camera Error (PT-BR)",
      "Broken": "Unable to access the camera. Please check your device settings. (PT-BR)",
      "InvalidQRCode": "The QR code could not be recognized. Please try again. (PT-BR)",
    },
    "Network": {
      "Title": "Server Error (PT-BR)",
      "UnknownServerErrorDescription": "An unknown server error occurred. Please try again later. (PT-BR)",
      "NoInternetTitle": "No Internet Connection (PT-BR)",
      "NoInternetDescription": "No internet connection. Please check your network settings and try again. (PT-BR)",
      "ServerErrorDescription": "There is a problem with the service. Please try again later. (error 302) (PT-BR)",
      "TimeoutTitle": "Connection Error (PT-BR)",
      "TimeoutDescription": "Please try again later. (PT-BR)",
      "UnsecuredTitle": "Unsecured Network (PT-BR)",
      "UnsecuredDescription": "A secure internet connection is required. Please check your network and try again. (PT-BR)",
      "ConnectionProblem": "There was a problem with the connection. Please try again. (PT-BR)",
      "EmptyResponse": "The server returned an empty response. Please try again. (PT-BR)",
      "BadRequest": "The request was invalid. Please try again. (PT-BR)",
      "ServerOutage": "The service is currently unavailable. Please try again later. (PT-BR)",
      "RetryLater": "The service is busy. Please try again later. (PT-BR)",
      "InvalidURL": "The URL is invalid. Please check and try again. (PT-BR)",
      "TooManyAttemptsTitle": "Sorry, You've Tried Too Many Times (PT-BR)",
      "TooManyAttemptsDescription": "Please try again later. (PT-BR)",
    },
    "Login": {
      "Title": "Problem with App (PT-BR)",
      ...
      "InvalidPairingCodeTitle": "Invalid Pairing Code (PT-BR)",
      "InvalidPairingCodeDescription": "You've entered an invalid pairing code. Please re-enter your pairing code and try again. (PT-BR)",
      "SameDeviceInvalidPairingCodeTitle": "Invalid Login (PT-BR)",
      "SameDeviceInvalidPairingCodeDescription": "Please try again later. If the problem continues, contact the BC Services Card Help Desk. (PT-BR)",
    },
    "Card": {
      "Title": "Card Error (PT-BR)",
      "ExpiredWillRemove": "Your card has expired and will be removed. (PT-BR)",
      "Cancelled": "Your card has been cancelled. (PT-BR)",
      "Expired": "Your card has expired. (PT-BR)",
      "Removed": "Your card has been removed. (PT-BR)",
      "TypeChanged": "Your card type has changed. (PT-BR)",
      "NotFound": "The card could not be found. (PT-BR)",
      "WillExpire": "Your physical card will expire soon. Please renew it. (PT-BR)",
    },
    "Verification": {
      "Title": "Verification Error (PT-BR)",
      "NotCompleteTitle": "Verify Not Complete (PT-BR)",
      "NotCompleteDescription": "Go to a Service BC location to verify your identity. (PT-BR)",
      "StepsIncomplete": "Some verification steps are incomplete. Please complete all required steps. (PT-BR)",
      "UploadServerError": "Failed to upload verification data. Please try again. (PT-BR)",
      "UploadUnknownError": "An unknown error occurred during upload. Please try again. (PT-BR)",
      "FileUploadError": "Failed to upload the file. Please try again. (PT-BR)",
      "VideoNotComplete": "Video verification is not complete. Please try again. (PT-BR)",
      "VideoCaptureError": "An error occurred while capturing video. Please try again. (PT-BR)",
      "RemoteIncomplete": "Remote verification is incomplete. Please complete the process. (PT-BR)",
      "DeleteRequestError": "Failed to delete the verification request. Please try again. (PT-BR)",
      "VideoServiceHoursNull": "Video service hours could not be retrieved. Please try again later. (PT-BR)",
      "VerifyRequestExpiredTitle": "Setup Expired (PT-BR)",
      "VerifyRequestExpiredDescription": "You must start set up again. (PT-BR)",
    },
    "Token": {
      "Title": "Problem with App (PT-BR)",
      "Invalid": "There may be a problem with your account in this app. Please try again. If the problem continues, remove and add your account again. (PT-BR)",
      "NoTokensReturnedTitle": "Problem with Account (PT-BR)",
      "NoTokensReturnedDescription": "No authentication tokens were returned. Please try again. (PT-BR)",
      "Null": "Authentication token is missing. Please sign in again. (PT-BR)",
      "ExpiryError": "Failed to retrieve token expiry. Please sign in again. (PT-BR)",
      "DecryptVerifyError": "Failed to verify authentication. Please sign in again. (PT-BR)",
      "DeserializeError": "Failed to process authentication. Please sign in again. (PT-BR)",
      "ParseJWTError": "Failed to parse authentication token. Please sign in again. (PT-BR)",
      "DecryptJWEError": "Failed to decrypt authentication data. Please sign in again. (PT-BR)",
      "MissingJWK": "Authentication key is missing. Please sign in again. (PT-BR)",
      "JWSVerificationFailed": "Authentication verification failed. Please sign in again. (PT-BR)",
      "JOSEException": "An authentication error occurred. Please sign in again. (PT-BR)",
      "ClaimsSetError": "Failed to process authentication claims. Please sign in again. (PT-BR)",
      "SignClaimsError": "Failed to sign authentication claims. Please try again. (PT-BR)",
      "ParseJWSError": "Failed to parse authentication signature. Please sign in again. (PT-BR)",
      "JWTDeviceInfoError": "Failed to process device authentication info. Please try again. (PT-BR)",
    },
    "Storage": {
      "Title": "Storage Error (PT-BR)",
      "WriteError": "Failed to save data. Please try again. (PT-BR)",
      "ReadError": "Failed to read data. Please try again. (PT-BR)",
      "KeychainKeyExists": "A security key already exists. Please contact support. (PT-BR)",
      "KeychainKeyNotFound": "Security key not found. Please sign in again. (PT-BR)",
      "KeychainGenerationError": "Failed to generate security key. Please try again. (PT-BR)",
      "DeleteKeyPairError": "Failed to delete security key. Please try again. (PT-BR)",
      "KeysOutOfSync": "Your security keys are out of sync. Please sign in again. (PT-BR)",
      "ToJSONFailure": "Failed to convert data to JSON format. Please try again. (PT-BR)",
      "ToJSONStringFailure": "Failed to serialize data. Please try again. (PT-BR)",
    },
    "Device": {
      "Title": "Device Error (PT-BR)",
      "AppUpdateRequiredTitle": "App Update Required (PT-BR)",
      "AppUpdateRequiredDescription": "You must update this app to continue. (PT-BR)",
      "ProtectionRequired": "Device protection is required. Please enable a passcode or biometrics. (PT-BR)",
      "ClockSkew": "Your device clock is not synchronized. Please check your date and time settings. (PT-BR)",
      "AuthorizationError": "Device authorization failed. Please try again. (PT-BR)",
      "IncorrectOS": "This app is not supported on your current operating system. (PT-BR)",
      "KeypairGenerationError": "The app does not appear to be installed correctly. Please remove the app from your device and add it again. (PT-BR)",
      "KeypairGenerationTitle": "Problem with App (PT-BR)",
    },
    "General": {
      "Title": "Something Went Wrong (PT-BR)",
      "Unknown": "An unexpected error occurred. Please try again. (PT-BR)",
      "RegistrationError": "Registration failed. Please try again. (PT-BR)",
      "AppVersionNotSupported": "This app version is no longer supported. Please update. (PT-BR)",
      "RegistrationNull": "Registration data is missing. Please try again. (PT-BR)",
      "AuthorizationNull": "Authorization data is missing. Please try again. (PT-BR)",
      "DeserializeError": "Failed to process data. Please try again. (PT-BR)",
      "SerializeError": "Failed to prepare data. Please try again. (PT-BR)",
      "ProviderNull": "Service provider data is missing. Please try again. (PT-BR)",
      "RegistrationFailure": "Client registration failed. Please try again. (PT-BR)",
      "CreateRegistrationFailed": "Failed to create registration. Please try again. (PT-BR)",
      "InvalidRegistration": "The registration request is invalid. Please try again. (PT-BR)",
      "MissingJSONValues": "Required data is missing from the response. Please try again. (PT-BR)",
      "ServerConfiguration": "Server configuration error. Please try again later. (PT-BR)",
      "AddCardServerError": "Failed to add card due to a server error. Please try again. (PT-BR)",
      "PINStoreError": "Failed to store PIN. Please try again. (PT-BR)",
      "ProviderError": "Service provider error. Please try again. (PT-BR)",
      "FetchedProviderNull": "Failed to fetch service provider. Please try again. (PT-BR)",
      "TermsOfUseError": "Failed to load terms of use. Please try again. (PT-BR)",
      "EmptyKeychain": "Security credentials are empty. Please sign in again. (PT-BR)",
