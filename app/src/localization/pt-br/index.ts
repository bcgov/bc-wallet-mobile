...
const translation = {
  ...
  "BCWalletError": {
    ...
    "Network": {
      ...
      "ConnectionTitle": "Connection Error (PT-BR)",
      ...
      "UnexpectedServerError": "There is a problem with the service. Please try again later. (PT-BR)",
      ...
      "UnexpectedError": "An unexpected network error occurred. Please try again. (PT-BR)",
    ...
    "Login": {
      "Title": "Login Error (PT-BR)",
      "ParseError": "Unable to process the login request. Please try again. (PT-BR)",
      "Rejected": "Your login request was rejected. Please try again. (PT-BR)",
      "Unauthorized": "You are not authorized to access this service. (PT-BR)",
      "Forbidden": "Access to this service is forbidden. (PT-BR)",
      "ServerError": "A server error occurred during login. Please try again. (PT-BR)",
      "InvalidPairingCode": "The pairing code is invalid. Please check and try again. (PT-BR)",
      "TooManyAttempts": "Too many login attempts. Please wait and try again. (PT-BR)",
      "TooManyAccounts": "You have too many active accounts. Please remove one before adding another. (PT-BR)",
    },
    "Card": {
    ...
    "Verification": {
      ...
      "NotComplete": "Verification is not complete. Please complete the verification process. (PT-BR)",
    ...
    "Token": {
      "Title": "Authentication Error (PT-BR)",
      "Invalid": "The authentication token is invalid. Please sign in again. (PT-BR)",
      "NoTokensReturned": "No authentication tokens were returned. Please try again. (PT-BR)",
    ...
    "Device": {
      ...
      "AppUpdateRequired": "An app update is required. Please update to continue. (PT-BR)",
      ...
      "KeypairGenerationError": "Failed to generate device keys. Please try again. (PT-BR)",
    },
    "General": {
