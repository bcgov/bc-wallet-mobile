...
const translation = {
  ...
  "BCSC": {
    ...
    "Onboarding": {
      ...
      "CarouselServicesContent": "It's accepted by many governement services. (PT-BR)",
      "CarouselProveContentA": "Log in using just this app. No username or password needed. (PT-BR)",
      "CarouselProveContentB": "Access services from any device by approving login in this app. (PT-BR)",
      "CarouselCannotUseContentA": "It's not a place to store a digital copy of your BC Services Card. (PT-BR)",
      "CarouselCannotUseContentB": "It's your account to access services online only. (PT-BR)",
      ...
      "NotificationsContinueButtonSecondary": "Continue without notifications (PT-BR)",
