    ...
    .withOverrides(
      (theme): DeepPartial<ITheme> => ({
        Buttons: {
          ...
          critical: { padding: Spacing.sm, backgroundColor: theme.ColorPalette.semantic.error },
          tertiary: {
            padding: Spacing.sm,
            borderRadius: 4,
            borderWidth: 0,
          ...
          modalPrimary: { padding: Spacing.sm },
          modalPrimaryDisabled: { padding: Spacing.sm },
          modalPrimaryText: { textAlign: 'center', color: v.textOnWhite },
          modalSecondary: { padding: Spacing.sm, borderColor: theme.ColorPalette.brand.primary },
          modalSecondaryDisabled: { padding: Spacing.sm },
          modalSecondaryText: { textAlign: 'center' },
          modalCritical: { padding: Spacing.sm, backgroundColor: theme.ColorPalette.semantic.error },
          modalCriticalDisabled: { padding: Spacing.sm },
          criticalTextDisabled: undefined,
          modalCriticalTextDisabled: undefined,
          modalSecondaryTextDisabled: undefined,
          modalTertiary: { padding: Spacing.sm },
          modalTertiaryDisabled: { padding: Spacing.sm },
