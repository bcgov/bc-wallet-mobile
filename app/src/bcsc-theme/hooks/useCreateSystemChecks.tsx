...
import useTokenApi, { useTokenService } from '@/bcsc-theme/api/hooks/useTokens'
...
import useRegistrationApi, { useRegistrationService } from '../api/hooks/useRegistrationApi'
