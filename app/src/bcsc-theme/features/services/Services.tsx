...
const mockServices: ServiceData[] = [
  ...
  },
  {
    ...
    description: 'View your B.C. health records in one place, including lab test results, medications, health visits, immunizations and more.',
    onPress: () => null,
  },
  {
    id: '3',
...
const Services: React.FC = () => {
  ...
  return (
    <TabScreenWrapper>
      <ThemedText variant={'headingThree'} style={styles.headerText}>Browse websites you can log in to with this app</ThemedText>
