...
const EnterBirthdateScreen: React.FC<EnterBirthdateScreenProps> = ({ navigation }: EnterBirthdateScreenProps) => {
  ...
  const onSubmit = useCallback(async () => {
    try {
      ...
      const { expires_in, user_code, device_code, verified_email } = await authorization.verifyInPerson(store.bcsc.serial, date)
      ...
      console.error('Error submitting birthdate:', error)
