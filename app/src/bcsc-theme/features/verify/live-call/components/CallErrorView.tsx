    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: ColorPalette.brand.primaryBackground, padding: Spacing.md }}>
      <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
        ...
        <ThemedText variant={'headingTwo'} style={{ marginTop: Spacing.lg, textAlign: 'center' }}>
          {t('Unified.VideoCall.Errors.ConnectionError')}
        </ThemedText>
      ...
      <View style={{ gap: Spacing.sm }}>
        {onRetry && (
          <Button
            ...
            onPress={onRetry}
            title={t('Unified.VideoCall.Errors.TryAgain')}
            accessibilityLabel={t('Unified.VideoCall.Errors.TryAgain')}
        ...
        <Button
          ...
          onPress={onGoBack}
          title={t('Unified.VideoCall.Errors.GoBack')}
          accessibilityLabel={t('Unified.VideoCall.Errors.GoBack')}
