...
type EnterSerialNumberScreenProps = {
...
const EnterSerialNumberScreen: React.FC<EnterSerialNumberScreenProps> = ({ navigation, route }) => {
...
export default EnterSerialNumberScreen
