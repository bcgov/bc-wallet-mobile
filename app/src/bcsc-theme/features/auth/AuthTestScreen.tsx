...
export const AuthTestScreen: React.FC = () => {
  ...
  const testSetAccount = async () => {
    try {
      ...
      // Auto-fetch account to get the generated ID
      const result = await getAccount()
      setAccountID(result?.id ?? null)
      logResult('setAccount', `Success! Account ID: ${result?.id}`)
    } catch (e) {
  ...
  const testSetPIN = async () => {
    if (!accountID) {
      logError('setPIN', 'No account ID - call Set Account then Get Account first')
      return
    }
    try {
      const result = await setPIN(accountID, TEST_PIN)
  ...
  const testVerifyPIN = async () => {
    if (!accountID) {
      logError('verifyPIN', 'No account ID - call Set Account first')
      return
    }
    try {
      const result = await verifyPIN(accountID, TEST_PIN)
  ...
  const testVerifyWrongPIN = async () => {
    if (!accountID) {
      logError('verifyPIN (wrong)', 'No account ID - call Set Account first')
      return
    }
    try {
      const result = await verifyPIN(accountID, '000000')
  ...
  const testDeletePIN = async () => {
    if (!accountID) {
      logError('deletePIN', 'No account ID - call Set Account first')
      return
    }
    try {
      const result = await deletePIN(accountID)
  ...
  const testHasPINSet = async () => {
    if (!accountID) {
      logError('hasPINSet', 'No account ID - call Set Account first')
      return
    }
    try {
      const result = await hasPINSet(accountID)
  ...
  const testIsPINAutoGenerated = async () => {
    if (!accountID) {
      logError('isPINAutoGenerated', 'No account ID - call Set Account first')
      return
    }
    try {
      const result = await isPINAutoGenerated(accountID)
  ...
  const testSetSecurityMethod = async () => {
    if (!accountID) {
      logError('setAccountSecurityMethod', 'No account ID - call Get Account first')
      return
    }
    try {
      const result = await setAccountSecurityMethod(accountID, AccountSecurityMethod.DeviceAuth)
  ...
  const testGetSecurityMethod = async () => {
    if (!accountID) {
      logError('getAccountSecurityMethod', 'No account ID - call Get Account first')
      return
    }
    try {
      const result = await getAccountSecurityMethod(accountID)
  ...
  const testIsAccountLocked = async () => {
    if (!accountID) {
      logError('isAccountLocked', 'No account ID - call Get Account first')
      return
    }
    try {
      const result = await isAccountLocked(accountID)
  ...
  const testSetupDeviceSecurity = async () => {
    if (!accountID) {
      logError('setupDeviceSecurity', 'No account ID - call Get Account first')
      return
    }
    try {
      const result = await setupDeviceSecurity(accountID)
  ...
  const testUnlockWithDeviceSecurity = async () => {
    if (!accountID) {
      logError('unlockWithDeviceSecurity', 'No account ID - call Get Account first')
      return
    }
    try {
      const result = await unlockWithDeviceSecurity(accountID, 'Unlock to test')
