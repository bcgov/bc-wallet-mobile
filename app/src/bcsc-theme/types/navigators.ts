...
export enum BCSCScreens {
  ...
  DualIdentificationRequired = 'BCSCDualIdentificationRequired', // Secondary ID Options for Non-BCSC / Foundation ID Options for Non-BCSC / Secondary ID for Non-Photo BC Services Card
