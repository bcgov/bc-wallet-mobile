...
export const ErrorRegistry = {
  ...
  CARD_SCAN_BIRTHDATE_INVALID: {
    code: 2307,
    alertEvent: AlertEvent.CARD_SCAN_BIRTHDATE_INVALID,
    titleKey: 'BCWalletError.Card.Title',
    descriptionKey: 'BCWalletError.Card.ScanBirthdateInvalid',
    severity: ErrorSeverity.WARNING,
    category: ErrorCategory.CREDENTIAL,
  },
  CARD_MISMATCH_ERROR: {
    code: 2308,
    alertEvent: AlertEvent.CARD_MISMATCH,
    titleKey: 'BCWalletError.Card.Title',
    descriptionKey: 'BCWalletError.Card.Mismatch',
    severity: ErrorSeverity.WARNING,
    category: ErrorCategory.CREDENTIAL,
  },
  PROOF_FORMAT_LOOKUP_ERROR: {
    code: 2309,
    alertEvent: AlertEvent.PROOF_FORMAT_LOOKUP_ERROR,
    titleKey: 'BCWalletError.Card.Title',
    descriptionKey: 'BCWalletError.Card.ProofFormatLookupError',
    severity: ErrorSeverity.ERROR,
    category: ErrorCategory.CREDENTIAL,
  },
  CREDENTIAL_LOOKUP_ERROR: {
    code: 2310,
    alertEvent: AlertEvent.CREDENTIAL_LOOKUP_ERROR,
    titleKey: 'BCWalletError.Card.Title',
    descriptionKey: 'BCWalletError.Card.LookupError',
    severity: ErrorSeverity.ERROR,
    category: ErrorCategory.CREDENTIAL,
  },
  ...
  EMAIL_SUBMISSION_ERROR: {
    code: 2409,
    alertEvent: AlertEvent.EMAIL_SUBMISSION_ERROR,
    titleKey: 'BCWalletError.Verification.Title',
    descriptionKey: 'BCWalletError.Verification.EmailSubmissionError',
    severity: ErrorSeverity.ERROR,
    category: ErrorCategory.VERIFICATION,
  },
  EMAIL_VERIFICATION_ERROR: {
    code: 2410,
    alertEvent: AlertEvent.EMAIL_VERIFICATION_ERROR,
    titleKey: 'BCWalletError.Verification.Title',
    descriptionKey: 'BCWalletError.Verification.EmailVerificationError',
    severity: ErrorSeverity.ERROR,
    category: ErrorCategory.VERIFICATION,
  },
  PHOTO_CAPTURE_ERROR: {
    code: 2411,
    alertEvent: AlertEvent.PHOTO_CAPTURE_ERROR,
    titleKey: 'BCWalletError.Verification.Title',
    descriptionKey: 'BCWalletError.Verification.PhotoCaptureError',
    severity: ErrorSeverity.ERROR,
    category: ErrorCategory.VERIFICATION,
  },
  VIDEO_CALL_CONNECTION_ERROR: {
    code: 2412,
    alertEvent: AlertEvent.VIDEO_CALL_CONNECTION_ERROR,
    titleKey: 'BCWalletError.Verification.Title',
    descriptionKey: 'BCWalletError.Verification.VideoCallConnectionError',
    severity: ErrorSeverity.ERROR,
    category: ErrorCategory.VERIFICATION,
  },
  VIDEO_CALL_SESSION_ERROR: {
    code: 2413,
    alertEvent: AlertEvent.VIDEO_CALL_SESSION_ERROR,
    titleKey: 'BCWalletError.Verification.Title',
    descriptionKey: 'BCWalletError.Verification.VideoCallSessionError',
    severity: ErrorSeverity.ERROR,
    category: ErrorCategory.VERIFICATION,
  },
  VIDEO_CALL_END_ERROR: {
    code: 2414,
    alertEvent: AlertEvent.VIDEO_CALL_END_ERROR,
    titleKey: 'BCWalletError.Verification.Title',
    descriptionKey: 'BCWalletError.Verification.VideoCallEndError',
    severity: ErrorSeverity.ERROR,
    category: ErrorCategory.VERIFICATION,
  },
  ...
  REFRESH_TOKEN_EXPIRED: {
    code: 2515,
    alertEvent: AlertEvent.REFRESH_TOKEN_EXPIRED,
    titleKey: 'BCWalletError.Token.Title',
    descriptionKey: 'BCWalletError.Token.RefreshExpired',
    severity: ErrorSeverity.ERROR,
    category: ErrorCategory.TOKEN,
  },
  ...
  DEVICE_CODE_MISSING: {
    code: 2708,
    alertEvent: AlertEvent.DEVICE_CODE_MISSING,
    titleKey: 'BCWalletError.Device.Title',
    descriptionKey: 'BCWalletError.Device.DeviceCodeMissing',
    severity: ErrorSeverity.ERROR,
    category: ErrorCategory.DEVICE,
  },
  ...
  FACTORY_RESET_ACCOUNT_NOT_FOUND: {
    code: 2822,
    alertEvent: AlertEvent.FACTORY_RESET_ACCOUNT_NOT_FOUND,
    titleKey: 'BCWalletError.General.Title',
    descriptionKey: 'BCWalletError.General.FactoryResetAccountNotFound',
    severity: ErrorSeverity.ERROR,
    category: ErrorCategory.GENERAL,
  },
  FACTORY_RESET_SERVER_ERROR: {
    code: 2823,
    alertEvent: AlertEvent.FACTORY_RESET_SERVER_ERROR,
    titleKey: 'BCWalletError.General.Title',
    descriptionKey: 'BCWalletError.General.FactoryResetServerError',
    severity: ErrorSeverity.ERROR,
    category: ErrorCategory.GENERAL,
  },
  ANALYTICS_INIT_ERROR: {
    code: 2824,
    alertEvent: AlertEvent.ANALYTICS_INIT_ERROR,
    titleKey: 'BCWalletError.General.Title',
    descriptionKey: 'BCWalletError.General.AnalyticsInitError',
    severity: ErrorSeverity.WARNING,
    category: ErrorCategory.GENERAL,
    showModal: false,
  },
  ...
  ATTESTATION_CREDENTIAL_OFFER_ERROR: {
    code: 3110,
    alertEvent: AlertEvent.ATTESTATION_CREDENTIAL_OFFER_ERROR,
    titleKey: 'BCWalletError.Attestation.Title',
    descriptionKey: 'BCWalletError.Attestation.CredentialOfferError',
    severity: ErrorSeverity.ERROR,
    category: ErrorCategory.VERIFICATION,
  },
  ATTESTATION_PROOF_ERROR: {
    code: 3111,
    alertEvent: AlertEvent.ATTESTATION_PROOF_ERROR,
    titleKey: 'BCWalletError.Attestation.Title',
    descriptionKey: 'BCWalletError.Attestation.ProofError',
    severity: ErrorSeverity.ERROR,
    category: ErrorCategory.VERIFICATION,
  },
} as const
