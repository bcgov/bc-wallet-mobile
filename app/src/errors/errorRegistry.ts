...
export const ErrorRegistry = {
  ...
  // --- Device Authorization (device/code) card-status errors ---
  INVALID_PARAMETER: {
    statusCode: 2307,
    appEvent: AppEventCode.INVALID_PARAMETER,
    severity: ErrorSeverity.ERROR,
    category: ErrorCategory.CREDENTIAL,
    message: 'Device authorization request had a missing or invalid parameter value',
  },
  CARD_NOT_FOUND: {
    statusCode: 2308,
    appEvent: AppEventCode.CARD_NOT_FOUND,
    severity: ErrorSeverity.WARNING,
    category: ErrorCategory.CREDENTIAL,
    message: 'Card not found, or the birthdate/device assertion did not match the found card',
  },
  CARD_INACTIVE: {
    statusCode: 2309,
    appEvent: AppEventCode.CARD_INACTIVE,
    severity: ErrorSeverity.WARNING,
    category: ErrorCategory.CREDENTIAL,
  ...
  CARD_EXPIRED: {
    statusCode: 2310,
    appEvent: AppEventCode.CARD_EXPIRED,
    severity: ErrorSeverity.WARNING,
    category: ErrorCategory.CREDENTIAL,
  ...
  CARD_REPLACED: {
    statusCode: 2311,
    appEvent: AppEventCode.CARD_REPLACED,
    severity: ErrorSeverity.WARNING,
    category: ErrorCategory.CREDENTIAL,
    message: 'Card has been replaced',
  },
  CARD_CANCELLED: {
    statusCode: 2312,
    appEvent: AppEventCode.CARD_CANCELLED,
    severity: ErrorSeverity.WARNING,
    category: ErrorCategory.CREDENTIAL,
  ...
  CARD_RENEWED: {
    statusCode: 2313,
    appEvent: AppEventCode.CARD_RENEWED,
    severity: ErrorSeverity.WARNING,
    category: ErrorCategory.CREDENTIAL,
    message: 'Card has been renewed',
  },
  NON_PHOTO_CARD: {
    statusCode: 2314,
    appEvent: AppEventCode.NON_PHOTO_CARD,
    severity: ErrorSeverity.WARNING,
    category: ErrorCategory.CREDENTIAL,
    message: 'Card is a non-photo card and cannot be used for this flow',
  },
  CARD_PROBLEM: {
    statusCode: 2315,
    appEvent: AppEventCode.CARD_PROBLEM,
    severity: ErrorSeverity.ERROR,
    category: ErrorCategory.CREDENTIAL,
    message: 'There is a problem with the card identity data',
  },
  ADDITIONAL_CARD: {
    statusCode: 2316,
    appEvent: AppEventCode.ADDITIONAL_CARD,
    severity: ErrorSeverity.WARNING,
    category: ErrorCategory.CREDENTIAL,
    message: 'An additional non-photo card has been issued — this card is no longer authorized',
  },
  UNDER_MINIMUM_AGE: {
    statusCode: 2317,
    appEvent: AppEventCode.UNDER_MINIMUM_AGE,
    severity: ErrorSeverity.WARNING,
    category: ErrorCategory.CREDENTIAL,
    message: "Individual's age is below the minimum required for remote verification",
  },
  TOO_MANY_MOBILE_CARDS: {
    statusCode: 2318,
    appEvent: AppEventCode.TOO_MANY_MOBILE_CARDS,
    severity: ErrorSeverity.WARNING,
    category: ErrorCategory.CREDENTIAL,
    message: 'Account has more active mobile cards than allowed',
  },
