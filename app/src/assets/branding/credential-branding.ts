export enum CREDENTIALS {
  ...
  UNVERIFIED_PERSON_TEST_OLD = 'XZQpyaFa9hBUdJXfKHUvVg:2:unverified_person:0.1.0',
  UNVERIFIED_PERSON_PROD_OLD = '9wVuYYDEDtpZ6CYMqSiWop:2:unverified_person:0.1.0',
