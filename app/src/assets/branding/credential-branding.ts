...
export enum CREDENTIALS {
  ...
  SHOWCASE_LAWYER_DEV = 'GmVzJEQG8kmprdbFRogWQr:2:member_card:1.51',
  SHOWCASE_LAWYER_TEST = '2K2h7kf8VGTLtfoxJgWazf:2:member_card:1.51',
  SHOWCASE_LAWYER_PROD = 'XUxBrVSALWHLeycAUhrNr9:2:Member Card:1.5.1',
  SHOWCASE_STUDENT_DEV = 'GmVzJEQG8kmprdbFRogWQr:2:student_card:1.0',
  SHOWCASE_STUDENT_TEST = '2K2h7kf8VGTLtfoxJgWazf:2:student_card:1.0',
  SHOWCASE_STUDENT_PROD = 'XUxBrVSALWHLeycAUhrNr9:2:student_card:1.0',
  SHOWCASE_LAWYER2_PERSON_DEV = 'GmVzJEQG8kmprdbFRogWQr:2:Person:1.1',
  SHOWCASE_LAWYER2_PERSON_TEST = '2K2h7kf8VGTLtfoxJgWazf:2:Person:1.1',
