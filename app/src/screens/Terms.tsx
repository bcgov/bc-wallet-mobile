...
const Terms: React.FC = () => {
  ...
  const controls = !(store.onboarding.didAgreeToTerms === TermsVersion && store.authentication.didAuthenticate) && (
    <>
  ...
  return (
    <ScreenWrapper controls={controls}>
      ...
      <Text style={[style.bodyText, { marginTop: 20 }]}>
        ...
        qualification, affiliation, competence, or clearance issued by the Province or third party issuers that you can
        present to another party who needs to verify those credentials; and (b) verify the digital credentials of
        ...
        applicable, and such references will apply only to the extent that you have accessed and downloaded BC Wallet to
        your mobile device through that particular platform.
      </Text>
      ...
      <View style={style.paragraph}>
        ...
        <Text style={style.bodyText}>
          ...
          &nbsp;The parties to this EULA are you and the Province (collectively, the “Parties”). The Parties acknowledge
          that: (a) this EULA is concluded between the Parties only, and not with Apple Inc. (“Apple”); and (b) the
          Province, not Apple, is solely responsible for BC Wallet.
        </Text>
      </View>
      ...
      <View style={style.paragraph}>
        ...
        <Text style={style.bodyText}>
          ...
          your parent or guardian is responsible for your use of BC Wallet. If you have not met these requirements, you
          must not access or use BC Wallet.
        </Text>
      </View>
      ...
      <View style={style.paragraph}>
        ...
        <Text style={style.bodyText}>
          ...
          &nbsp;BC Wallet, including without limitation trademarks, trade names, logos, domain names, images, graphics,
          graphical user interface elements and designs, in any form or medium whatsoever, are owned by the Province or
          its licensors and are protected by copyright, patent, trademark and other laws protecting intellectual
          property rights.
        </Text>
      </View>
      <View style={style.paragraph}>
        ...
        <Text style={style.bodyText}>
          ...
          &nbsp;Digital credentials are owned by the party identified in the agreement between the issuer and the holder
          concerning the credential. Any other information and works stored, made available, displayed or transmitted by
          you in connection with BC Wallet, including any information relating to credentials you have verified
          (collectively, “Content”) are, between the Province and you, owned by you and are protected by copyright,
          patent, trademark and other laws protecting intellectual property rights. Subject to this EULA, you grant the
          Province a limited license to access, use, process, copy, distribute, perform, and display your Content
          (including reformatting and modification for display) solely to the extent necessary to provide BC Wallet to
          you. You are solely responsible for the accuracy, content and legality of your Content and you represent and
          warrant that you have all necessary intellectual property rights to grant the Province this limited license to
          use your Content. The Province has no obligation to monitor your Content.
        </Text>
      </View>
      <View style={style.paragraph}>
      ...
      <View style={style.paragraph}>
        ...
        <Text style={style.bodyText}>
          ...
          control and as permitted by the Usage Rules set forth in the Apple Media Services Terms and Conditions located
          at{'\n'}
          ...
          time (the “License”). Except as provided in the App Store Terms (which does permit Licensed Applications to be
          accessed, acquired, and used by other accounts associated with the purchaser via Family Sharing or volume
          ...
          reverse-engineer, disassemble, attempt to derive the source code of, modify, or create derivative works of BC
          Wallet, any updates, upgrades or any part of BC Wallet (except as and only to the extent that any foregoing
          restriction is prohibited by applicable law or to the extent as may be permitted by the licensing terms
          governing use of any open-sourced components included with BC Wallet).
        </Text>
      </View>
      <View style={style.paragraph}>
        ...
        <Text style={style.bodyText}>
          ...
          &nbsp;The License will terminate automatically in the event that you fail to comply with any of the terms and
          conditions of this EULA or if any of your representations or warranties are or become inaccurate or
      ...
      <View style={style.paragraph}>
        ...
        <Text style={style.bodyText}>
          ...
          whatsoever to furnish any maintenance and support services with respect to BC Wallet. All questions respecting
          the Support Services, and all general inquiries respecting BC Wallet, should be directed to: Product Owner, BC
          Wallet, ditrust@gov.bc.ca, 4000 Seymour Place, Victoria, BC, V8W 9V1.
        </Text>
      </View>
      <View style={style.paragraph}>
      ...
      <View style={style.paragraph}>
        ...
        >
          <Text style={style.bodyText}>
            ...
            &nbsp;To the maximum extent permitted by applicable law, under no circumstances will the Province be liable
            to any person or entity for any direct, indirect, special, incidental, consequential or other loss, claim,
            injury or damage, whether foreseeable or unforeseeable (including without limitation claims for damages for
            loss of profits or business opportunities, use or misuse of, or inability to use, BC Wallet, interruptions,
            deletion or corruption of files, loss of programs or information, errors, defects or delays) arising out of
            or in any way connected with your use of BC Wallet and whether based on contract, tort, strict liability or
            any other legal theory. The previous sentence will apply even if the Province has been specifically advised
      ...
      <View style={style.paragraph}>
        ...
        <Text style={style.bodyText}>
          ...
          &nbsp;BC Wallet is owned by the Province or used by the Province under license. The Parties acknowledge that,
          in the event of any third-party claim that BC Wallet or your possession and/or use of BC Wallet infringes that
          third party’s intellectual property rights, the Province, and not Apple, is solely responsible for the
          investigation, defence, settlement and discharge of any such claim. In the event of any such claim, the
          Province reserves the right to replace any portion of BC Wallet that allegedly infringes a third party’s
      ...
      <View style={style.paragraph}>
        ...
        <Text style={style.bodyText}>
          ...
          and expenses (including but not limited to reasonable legal fees) arising from or related to: (a) your use of
          BC Wallet (b) your Content; or (c) your violation of any provision of this EULA.
        </Text>
      </View>
      <View style={style.paragraph}>
        ...
        <Text style={style.bodyText}>
          ...
          “personal information”, as defined in the BC Freedom of Information and Protection of Privacy Act (the “Act”),
          is collected by the Province under section 26(c) of the Act for the purposes set out in the Privacy Policy.
          Any questions about the collection of such information can be directed to the contact set out in section 11.
          The consents provided by you as set out in this section will continue unless and until revoked by you in
          writing to the contact set out in section 11, in which case this EULA will terminate immediately pursuant to
          section 9.
        </Text>
      </View>
      ...
      <View style={style.paragraph}>
        ...
        <Text style={style.bodyText}>
          ...
          third party web site, you may be subject to the terms of use and/or the privacy policy, if any, of that third
          party web site; and (c) the Province does not endorse the content of any third party web sites and is not
          responsible for the terms of use, privacy policies, practices or content of any third party web site.
        </Text>
      </View>
      ...
      <View style={style.paragraph}>
        ...
        <Text style={style.bodyText}>
          ...
          &nbsp;You represent and warrant that: (a) you are not located in a region that is subject to a U.S. government
          embargo, or that has been designated by the U.S. government as a “terrorist supporting” region; and (b) you
      ...
      <View style={[style.paragraph, { marginBottom: 30 }]}>
        ...
        <Text style={style.bodyText}>
          ...
          between you and the Province with respect to the subject matter of this EULA. The headings in these Terms are
          inserted for convenience only and will not be used in interpreting or construing any provision of this EULA.
          If any provision of this EULA is invalid, illegal or unenforceable, that provision will be severed from this
          EULA and all other provisions will remain in full force and effect. This EULA will be governed by and
          construed in accordance with the laws of the province of British Columbia and the applicable laws of Canada.
