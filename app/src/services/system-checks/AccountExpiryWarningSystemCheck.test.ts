...
describe('AccountExpiryWarningSystemCheck', () => {
  beforeAll(() => {
    jest.useFakeTimers()
  ...
  describe('runCheck', () => {
    it('should return true if the account is expired (yesterday)', () => {
      ...
      const check = new AccountExpiryWarningSystemCheck(expiredDate, {} as SystemCheckUtils)
    ...
    it('should return false if the account is expiring within the warning period (30 days)', () => {
      ...
      const check = new AccountExpiryWarningSystemCheck(expiringSoonDate, {} as SystemCheckUtils)
    ...
    it('should return true if the account is not expiring soon (31 days)', () => {
      ...
      const check = new AccountExpiryWarningSystemCheck(validDate, {} as SystemCheckUtils)
  ...
  describe('onFail', () => {
    it('should dispatch a warning banner if the account is expiring soon', () => {
      ...
      const check = new AccountExpiryWarningSystemCheck(date, {
        dispatch: jest.fn(),
