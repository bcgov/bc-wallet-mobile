...
abstract class BcscCoreSpec internal constructor(
    ...
    abstract fun deletePIN(
        accountID: String,
        promise: Promise,
    )

    abstract fun hasPINSet(
        accountID: String,
        promise: Promise,
    )
    ...
    abstract fun getAccountSecurityMethod(
        accountID: String,
        promise: Promise,
    )

    abstract fun isAccountLocked(
        accountID: String,
        promise: Promise,
    )
    ...
    abstract fun setupDeviceSecurity(
        accountID: String,
        promise: Promise,
    )
    ...
    abstract fun isPINAutoGenerated(
        accountID: String,
        promise: Promise,
    )
